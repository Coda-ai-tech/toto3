        ...
        return t = e, (a = [{
            ...
            value: function () {
                ...
                return $("[data-modal-open]").on("click", function (n) {
                    ...
                    e = '<div class="modal" data-modal>                            <div data-modal-close class="modal-bg"></div>                                <div class="modal-inner">                                    <div id="player">                                        <video data-video-id                                         data-account="4631489730001"                                         data-player="BJKE2i5G"                                         data-embed="default"                                         data-application-id                                         class="video-js"                                         controls></video>                                        <script src="//players.brightcove.net/4631489730001/BJKE2i5G_default/index.min.js"></script>                                    <div data-modal-close class="modal-close" tabindex="0"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 19 18"><path fill-rule="evenodd" fill="rgb(255, 255, 255)" d="M18.109,15.876 L15.979,17.992 L9.58,11.115 L2.137,17.992 L0.7,15.876 L6.928,8.999 L0.7,2.123 L2.137,0.7 L9.58,6.884 L15.979,0.7 L18.109,2.123 L11.188,8.999 L18.109,15.876 Z"></path></svg>CLOSE</div>                                </div>                            </div>                        </div>'.replace("data-video-id", 'data-video-id="' + o + '"'), i.$body.append(e), $("[data-modal]").fadeIn(400/*,function(){setTimeout(function(){$("#player video").get(0).play()}, 800);}*/),/*$("#player .video-js").addClass("vjs-has-started"),*/ a = i.$win.scrollTop(), t = "top: " + -a + "px !important;", $("#body_inner").addClass("is-fixed"), $("#body_inner").css({
                        cssText: t
                    })
                    /*add GA*/ 
                    setTimeout(function(){
                    ...
                    $("[data-modal]").fadeOut(), $("#body_inner").removeClass("is-fixed"), $("#body_inner").attr({
                        ...
                        scrollTop: a
                    }), $("#player .video-js").removeClass("vjs-has-started"), $("[data-modal]").remove()
                }),$(document).on("keypress", "[data-modal-close]", function (e) {
                    if( e.keyCode === 13 ){
                    $("[data-modal]").fadeOut(), $("#body_inner").removeClass("is-fixed"), $("#body_inner").attr({
                        style: ""
                    }), $("html, body").prop({
