...
/// 製品欄のコード生成
// --------------------------------------------------------
$text_title       = $_VARS['messages']['faucet_simulator_title'];
...
$text_lavatory    = $_VARS['messages']['lavatory_annotation'];
...
EOF;
	...
	<td class="border-bottom" width="{$_MAIN_PRODUCT_WIDTH}">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr><td class="large prooduct" align="left"><b>{$data['name']}</b></td></tr>
...
EOF;
	...
	<tr>
		...
		<td width="{$_MAIN_WIDTH}">
			<table cellpadding="5" cellspacing="0" border="0" width="100%">
				<tr>
					<td align="right" class="gray x-small">{$text_lavatory}</td>
				</tr>
			</table>
		</td>
		<td width="{$_MAIN_MARGIN}"></td>
	...
	<tr>
		<td colspan="3" height="{$_SECTION_SPACE_HEIGHT}"></td>
	</tr>
</table>
...
} else if ($_VARS['settings']['language'] == 'vn') {
	$myFont = $font->addTTFfont(dirname(__FILE__) . '/assets/font/Montserrat-Medium.ttf');
} else {
...
// ファイルを出力
$fileName = 'toto-faucet-lavatory-set.pdf';
