        ...
        return t = e, (a = [{
            ...
            value: function () {
                ...
                return $("[data-modal-open]").on("click", function (n) {
                    ...
                    e = '<div class="modal" data-modal>                            <div data-modal-close class="modal-bg"></div>                                <div class="modal-inner">                                    <div id="player">             <iframe id="inlineFrameExample" title="Inline Frame Example" width="100%" height="100%" src></iframe>	                                                                                                       <div data-modal-close class="modal-close" tabindex="0"></div>                                </div>                            </div>                        </div>'.replace("src", 'src="' + o + '"'), i.$body.append(e), $("[data-modal]").fadeIn(400,function(){setTimeout(function(){$("#player video").get(0).play()}, 800);}), /*setTimeout(function(){$("#player video").get(0).play()}, 800),*/ $("#player .video-js").addClass("vjs-has-started"), a = i.$win.scrollTop(), t = "top: " + -a + "px !important;", $("#body_inner").addClass("is-fixed"), $("#body_inner").css({
                        cssText: t
                    })
                    /*A11y VR focus*/
                    setTimeout(function(){
