        ...
        <div className='showcase-area'>
          ...
          <div className='area-main'>
            <div className='main-slide' data-slide-scmain>
              <div className='slide-item'>
                <img src='/assets/global/faucet/showcase/images/showcase_01-main.jpg' alt='' />
              </div>
              <div className='slide-item'>
                <img src='/assets/global/faucet/showcase/images/showcase_01-02.jpg' alt='' />
              </div>
              <div className='slide-item'>
                <img src='/assets/global/faucet/showcase/images/showcase_01-03.jpg' alt='' />
              </div>
              <div className='slide-item'>
                <img src='/assets/global/faucet/showcase/images/showcase_01-04.jpg' alt='' />
              </div>
            </div>
            <div className='main-ttl'>SPACE01</div>
          </div>
            ...
            <ul id='product' className='product-list'>
              <li>
                <span className='no-link'>
                  ...
                  <img src='/assets/global/faucet/showcase/images/space01_01.jpg' alt='' />
              ...
              <li>
                <span className='no-link'>
                  ...
                  <img src='/assets/global/faucet/showcase/images/space01_02.jpg' alt='' />
                  <span className='list-name'>FAUCET</span>
                </span>
              </li>
              <li>
                <span className='no-link'>
                  <span className='list-cat'>WASHBASIN</span>
                  <img src='/assets/global/faucet/showcase/images/space01_03.jpg' alt='' />
                  <span className='list-name'>WASHBASIN VESSEL TYPE</span>
                </span>
              </li>
              <li>
                <span className='no-link'>
                  <span className='list-cat'>BATH</span>
                  <img src='/assets/global/faucet/showcase/images/space01_04.jpg' alt='' />
              ...
              <li>
                <span className='no-link'>
                  ...
                  <img src='/assets/global/faucet/showcase/images/space01_05.jpg' alt='' />
              ...
              <li>
                <span className='no-link'>
                  ...
                  <img src='/assets/global/faucet/showcase/images/space01_06.jpg' alt='' />
              ...
              <li>
                <span className='no-link'>
                  <span className='list-cat'>ACCESSORY</span>
                  <img src='/assets/global/faucet/showcase/images/space01_07.jpg' alt='' />
