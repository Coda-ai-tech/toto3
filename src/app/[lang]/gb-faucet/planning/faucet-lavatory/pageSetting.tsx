  ...
  useEffect(() => {
    if (isAddedScript) {
      setTimeout(() => {
        ...
        // Initialize ENGINE modules and bind event handlers
        const script2 = document.createElement('script');
        const context1 = `
          console.log('==== Global Page ====');
          
          // Add required body classes for the simulator
          document.body.className = 'uq_faucet-lavatory-top is_faucet-lavatory is_en';
              ...
              setTimeout(() => {
                ...
                if (favoriteBtn && !favoriteBtn.hasAttribute('data-event-bound')) {
                  favoriteBtn.addEventListener('click', function(e) {
                    e.preventDefault();
                    console.log('Manual favorite button clicked');
                  ...
                  console.log('Manual favorite button event bound');
                }
                ...
                if (favoriteCloseBtn && !favoriteCloseBtn.hasAttribute('data-event-bound')) {
                  favoriteCloseBtn.addEventListener('click', function(e) {
                    e.preventDefault();
                    console.log('Manual favorite close button clicked');
                  ...
                  console.log('Manual favorite close button event bound');
                }
                ...
                transitionLinks.forEach((link, index) => {
                  if (!link.hasAttribute('data-manual-bound')) {
                    link.addEventListener('click', function(e) {
                      ...
                      console.log('Manual transition link clicked:', target);
                ...
                console.log('Manual transition links bound:', transitionLinks.length);
              }, 500);
