...
const PageSetting = () => {
  ...
  useEffect(() => {
    ...
    const scriptFiles = [
      ...
      '/assets/global/faucet/assets/js/swiper.min.js',
      '/assets/global/faucet/assets/js/gb_faucet.js',
      '/assets/global/faucet/assets/js/unique/index.js',
  ...
  return (
    <>
      ...
      <link rel='stylesheet' media='all' href='/assets/global/faucet/assets/css/swiper.css' />
      <link rel='stylesheet' media='all' href='/assets/global/faucet/assets/css/unique/index.css?v=230515' />
      <style
