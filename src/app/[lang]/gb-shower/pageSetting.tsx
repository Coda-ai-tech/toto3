...
const PageSetting = () => {
  ...
  useEffect(() => {
    ...
    const scriptFiles = [
      ...
      '/assets/global/shower/js/swiper.min.js',
      '/assets/global/shower/js/script.js',
  ...
  return (
    <>
      ...
      <link rel='stylesheet' media='all' href='/assets/global/shower/css/common.css' />
      <link rel='stylesheet' media='all' href='/assets/global/shower/css/swiper.css' />
      <link rel='stylesheet' media='all' href='/assets/global/shower/css/unique/index.css' />
      <style
