...
const PageSetting = () => {
  ...
  const scriptFiles = useMemo(() => {
    return [
      ...
      '/assets/global/washlet-history/js/ScrollMagic.min.js',
      '/assets/global/washlet-history/js/debug.addIndicators.min.js',
      '/assets/global/washlet-history/js/bundle.js',
    ];
  }, []);
  ...
  return (
    <>
      <link rel='stylesheet' media='all' href='/assets/global/washlet-history/css/main.css' />
      <style
