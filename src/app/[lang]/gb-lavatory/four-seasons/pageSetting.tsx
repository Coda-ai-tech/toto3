...
const PageSetting = () => {
  ...
  const scriptFiles = useMemo(() => {
    return [
      ...
      '/assets/global/lavatory/four_seasons/assets/js/top.js',
    ];
  }, []);
  ...
  useEffect(() => {
    if (!loading) {
      ...
      scriptFiles.forEach((url) => {
        ...
        if (url === '/assets/global/lavatory/four_seasons/assets/js/top.js') {
          script.type = 'module';
        }
  ...
  return (
    <>
      <link rel='stylesheet' media='all' href='/assets/global/lavatory/four_seasons/assets/css/style.css' />
      <style
