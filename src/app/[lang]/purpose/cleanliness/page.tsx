...
const pagePath = [
  {
    enTitle: 'BRAND PURPOSE Cleanliness and Comfort',
    zhTitle: 'BRAND PURPOSE Cleanliness and Comfort',
    slug: 'cleanliness',
  },
];
...
const metaProps = {
  en: {
    ...
    description: 'Learn about “Cleanliness and Comfort“ - one of the materiality issues that TOTO is focusing on.',
