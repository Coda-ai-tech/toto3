...
const pagePath = [
  {
    enTitle: 'BRAND PURPOSE Relationships',
    zhTitle: 'BRAND PURPOSE Relationships',
    slug: 'relationships',
  },
];
...
const metaProps = {
  en: {
    ...
    description: 'Learn about “Relationships“ - one of the materiality issues that TOTO is focusing on.',
